                    ...
                    <div class="row g-0">
                            ...
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center pb-4">
                                        ...
                                        <!-- Cambiar la ruta para que redirija a la recuperación de contraseña -->
                                        <a href="{{ route('password.email') }}" class="btn btn-outline-danger">Crear nueva</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                            <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                ...
                                <h5 class="mb-4">El sistema de directorio telefónico interno facilita el acceso rápido a los contactos de los funcionarios de la Vicepresidencia, mejorando la comunicación y la colaboración dentro de la institución</h5>
                            </div>
                        </div>
                    </div>
                </div>
